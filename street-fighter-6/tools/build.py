...
import argparse, base64, re, runpy
parser = argparse.ArgumentParser()
parser.add_argument('--pages', action='store_true', help='also write the built standalone page to this project folder index.html')
